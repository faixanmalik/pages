    ...
    <div className='bg-[#222222] p-[6px] px-20 2xl:px-40 flex items-center'>
      ...
      <div className='pl-10 flex flex-1 gap-6 items-center'>
        ...
        <div className="relative items-center ">
          ...
          <input type="search" id="default-search" className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-500 rounded-lg bg-[#222222] focus:ring-blue-500 focus:border-blue-500 dark:bg-[#222222] dark:border-[#8e8e8e] dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="search all the things..." required/>
        </div>
