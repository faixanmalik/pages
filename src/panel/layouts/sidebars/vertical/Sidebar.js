  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <Menu className='bg-black mt-10'>
          ...
          <MenuItem href="/menu/adminSettings/settings" icon={<IoSettings className='text-lg'/>} className={ location === '/panel' ?  'text-indigo-700 bg-zinc-50 font-medium' : 'text-gray-600 font-medium'} >
            System settings
          </MenuItem>
